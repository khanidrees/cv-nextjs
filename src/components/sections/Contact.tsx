    ...
    <section id="contact" className="section section-alt">
      <div className="container">
        ...
        <div className={styles.grid}>
          {/* Left: Contact Info */}
          <AnimatedSection direction="left" className={styles.info}>
            <div className={styles.infoCards}>
              {[
                ...
                },
                {
                  icon: '💼',
                  label: 'LinkedIn',
                  value: 'linkedin.com/in/khanidrees',
            ...
            <div className={styles.socials}>
              ...
              <a href={personalInfo.scaler} target="_blank" rel="noopener noreferrer" className={styles.socialBtn} aria-label="Scaler">
          ...
          {/* Right: Form */}
          <AnimatedSection direction="right" delay={0.15} className={styles.formWrapper}>
